...
import { selectIsAuth, selectIsLoading, selectProducts, selectTotal } from "../../redux/selectors";
...
const ProductsList = () => {
  ...
  useEffect(() => {
    if (!isAuth) return;
    dispatch(getProductsThunk(page, pageSize, sort, search));
    // : JSON.stringify(sort)  
    ...
    <Box m="2.5rem 2.5rem">
      ...
      >
        ...
        {...products}
          ...
          rows={(products && products.products) || []}
          columns={columns}
          // rowCount={(products && products.total) || 0}
          ...
          // onPaginationModelChange={(newPageSize) => setPage(newPageSize)}
